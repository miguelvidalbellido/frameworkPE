...
public class validar {
	...
	public static int solicitarNum(){
		...
		do{
			try{
				cad=JOptionPane.showInputDialog(null, "Introduce un número", "[INT]",JOptionPane.QUESTION_MESSAGE);
				if(cad==null){
	...
	/*								INT								*/
	/*						SOLICITAR NUM C/ARGUMENTOS				*/
	public static int solicitarNumArgumentos(String message, String title){
		String cad = "";
		int num = 0;
		boolean correct = false;
	...
	public static char solicitarChar(){
		...
		do{
			try{
				cad=JOptionPane.showInputDialog(null, "Introduce un carácter", "[CHAR]",JOptionPane.QUESTION_MESSAGE);
				if(cad==null){
					JOptionPane.showMessageDialog(null, "Saliendo de la aplicación","Saliendo",JOptionPane.INFORMATION_MESSAGE);
	...
	/*								CHAR								*/
	/*					SOLICITAR CHAR C/ARGUMENTOS						*/
	public static char solicitarCharArgumentos(String message, String title){
		String cad = "";
		char character = 0;
		boolean correct = false;
